...
public class Dzikir_soreActivity extends AppCompatActivity {
    ...
    String [] arabsore = {
            ...
            ""
            ,"[17]\n" +
            "اَللَّهُمَّ إِنِّيْ أَسْأَلُكَ عِلْمًا نَافِعًا، وَرِزْقًا طَيِّبًا، وَعَمَلاً مُتَقَبَّل\n" +
            "\n" +
            "\n" +
            "\n" +
            ""
    ...
    ViewPager viewPager;
    ViewPagerAdapterSore adaptersore;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dzikir_sore);
        viewPager = (ViewPager) findViewById(R.id.pagersore);
        adaptersore = new ViewPagerAdapterSore
                (Dzikir_soreActivity.this, arabsore,gambarsore,arti);
        viewPager.setAdapter(adaptersore);
    }
}
